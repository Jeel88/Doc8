    ...
    return (
        <div className="space-y-12 pb-12 ">
            ...
            <div className="relative py-12 md:py-24">
                ...
                <div className="absolute top-0 right-0 w-[300px] md:w-[600px] h-[300px] md:h-[600px] bg-blue-600/10 rounded-full blur-[80px] md:blur-[120px] -translate-y-1/2 translate-x-1/2 pointer-events-none"></div>
                ...
                <div className="relative z-10 px-4 md:px-12 flex flex-col md:flex-row items-center justify-center mx-auto max-w-6xl gap-12 text-center md:text-left">
                    <div className="max-w-3xl">
                        <h1 className="text-5xl md:text-7xl font-black tracking-tight mb-8 text-white leading-[1.1]">
                            Share Notes. <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">Learn</span> <br />
                        ...
                        <p className="text-xl md:text-2xl text-muted mb-10 leading-relaxed max-w-lg mx-auto md:mx-0">
                            The ultimate platform for college students. Upload, discover, and ace your exams with Doc<span className="text-blue-500 font-bold">8</span>.
                        </p>
                        <div className="flex flex-col sm:flex-row items-center gap-4 justify-center md:justify-start">
                            <Link to="/browse" className="w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400 text-white rounded-xl font-bold text-lg transition-all shadow-lg shadow-blue-500/25 flex items-center justify-center gap-2">
                                <UploadCloud size={24} />
                                Upload Notes
                            </Link>
                        </div>
                    ...
                    <div className="relative w-full max-w-sm aspect-square hidden md:flex items-center justify-center">
                        <div className="absolute -inset-4 bg-gradient-to-br from-blue-600 to-cyan-500 rounded-full opacity-25 blur-3xl animate-pulse"></div>
            ...
            {/* AI Teaser Section */}
            <div className="rounded-3xl bg-gradient-to-r from-blue-900 to-cyan-900 overflow-hidden relative mx-4 md:mx-0">
                ...
                <div className="relative z-10 px-6 py-12 md:p-16 flex flex-col md:flex-row items-center justify-between gap-12">
                    ...
                    <div className="w-full max-w-md bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/10 shadow-xl">
                        ...
                        <div className="bg-blue-500/30 rounded-lg p-4 border border-blue-400/30">
                            <p className="text-xs text-blue-200 mb-2">✨ AI Summary • 120 words</p>
